...
import { errorReply, getAudioDurationInSeconds, getSeekTime, getYTid, handleAudioResource, handleYTPlaylist, handleYTVideo } from '../lib/util.js';
import { fastSearch, playlistInfo, playlistItems } from '../lib/youtubeAPI.js';
...
async function processPlaylist(playlistId, youtubeAPIKey, interaction, url, player) {
    ...
    const playlistCallback = async function (successCount, _failCount) {
        let playlistInfoRes;
        try {
