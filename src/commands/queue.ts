...
async function createList(interaction: ChatInputCommandInteraction, player: Player, index: number): Promise<[EmbedBuilder] | undefined> {
...
function createComponents(index: number, numTabs: number): ActionRowBuilder<ButtonBuilder>[] {
